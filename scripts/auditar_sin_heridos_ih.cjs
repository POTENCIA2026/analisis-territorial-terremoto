...
const data={...fullData,healthPressure:{...fullData.healthPressure,human_impact_policy:{families_informational_only:false},housing_weight_policy:{enabled:false},education_relative_policy:{...fullData.healthPressure.education_relative_policy,normalization:'observed_max'},disabled_relative_indicators:[],source_cascade:{enabled:false}}};
