...
const data={...fullData,healthPressure:{...fullData.healthPressure,education_relative_policy:{...fullData.healthPressure.education_relative_policy,normalization:'observed_max'},disabled_relative_indicators:[]}},policy=data.healthPressure.source_cascade;
